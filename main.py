...
if __name__ == '__main__':
    ...
    print("Предсказания по модели:", predictions[0])
    print("Класс по модели:", np.argmax(predictions[0]))
    print("Нужный класс на выходе:", test_df['target'].iloc[0])

    print("\nТочность на тестовой выборке:", np.mean(accuracies))
